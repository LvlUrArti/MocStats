...
You can find the raw data in the [Hugging Face Dataset](https://huggingface.co/datasets/LvlUrArti/MocData). Feel free to analyze the data and post the findings. If you do, please credit me (LvlUrArti).
